...
const Navbar = () => {
  ...
  const isExploreActive = () =>
    exploreItems.some((item) => location.pathname === item.link);
  const isServicesActive = () =>
    serviceItems.some((item) => location.pathname === item.link);
  ...
  return (
    <>
      <AppBar
        ...
        sx={{
          background:
            "linear-gradient(to right, #f9fff4, #ebfdec, #f9fff4, #ebfdec, #f9fff4, #ebfdec)",
          boxShadow: "none",
                ...
                item.onClick ? (
                  <Button
                    ...
                    sx={{
                      ...
                      fontSize: "0.9rem",
                      color:
                        location.pathname === item.link ? "#e65100" : "#023047",
                      marginX: "10px",
                      fontWeight: "500",
                      fontFamily: "Excon",
                      "&:hover": {
        ...
        >
          <List>
              ...
              >
                ...
                <Link
                  ...
                  style={{
                    textDecoration: "none",
                    color:
                      location.pathname === item.link ? "#020220" : "white",
                    backgroundColor:
            ...
            <ListItem
              ...
              sx={{
                backgroundColor: isDropdownActive(exploreItems)
                  ? "white"
                  : "transparent",
            ...
            <ListItem
              ...
              sx={{
                backgroundColor: isDropdownActive(serviceItems)
                  ? "white"
                  : "transparent",
            ...
            <ListItem button>
              <Link
                ...
                style={{
                  textDecoration: "none",
                  color:
                    location.pathname === "/contact" ? "#020220" : "inherit",
                  backgroundColor:
            ...
            {/* <ListItem button>
              <a
                ...
                style={{
                  textDecoration: "none",
                  color:
                    location.pathname === "/buy-online" ? "#020220" : "inherit",
                  backgroundColor:
            ...
            <ListItem button>
              <Link
                ...
                style={{
                  textDecoration: "none",
                  color:
                    location.pathname === "/locations" ? "#020220" : "inherit",
                  backgroundColor:
